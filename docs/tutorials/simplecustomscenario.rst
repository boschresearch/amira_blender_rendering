...
Despite your python knowledge (and in particular about so-called *decorators*), for you to know
is that you have to make sure to add such line to your custom code.
