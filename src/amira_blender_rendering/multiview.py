...
from amira_blender_rendering.cli.render_dataset import get_cmd_argparser, get_scene_types, determine_scene_type, \
    import_abr, get_argv
...
scene_type_str = determine_scene_type(
    '/home/pll1tv/PycharmProjects/amira_blender_rendering/config/workstation_scenario01_multiview_train.cfg')  # liadp
...
configfile = expandpath(
    '/home/pll1tv/PycharmProjects/amira_blender_rendering/config/workstation_scenario01_multiview_train.cfg',
    check_file=True)
