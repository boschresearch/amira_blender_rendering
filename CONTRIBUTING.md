...
prior to any development to coordinate with the ABR development team early on in the process.
Coordinating up front helps to avoid frustration later on.

Your contribution must be licensd under the Apache-2.0 license, as that used by this project.
...
```
AMIRA Blender Rendering Developer's Certificate of Origin.  Version 1.0.0
...
The procedure is simple: To certify above AMIRA Blender Rendering Developer's Certificate of
...
If you are a developer who is authorized to contribute to AMIRA Blender Rendering 
